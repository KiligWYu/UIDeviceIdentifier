...
//  Collection
//
//  Created by yto on 07/12/2017.
//  Copyright © 2017 KiligWYu. All rights reserved.
//
...
class UIDeviceHardware {
    ...
    private static let platformStrings = [
        "iPhone1,1": "iPhone 1G",
        "iPhone1,2": "iPhone 3G",
    ...
    class func platformStringSimple() -> String {
        let platformString = self.platformString()
        return platformString.components(separatedBy: " (")[0]
    }
